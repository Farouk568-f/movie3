...
export const translations = {
  en: {
    ...
    'autoTimingCorrection': 'Auto Timing Correction',
    'autoTimingCorrectionDesc': 'Use English timing to auto-correct and translate subtitles (disable to use original timing)',
  ...
  ar: {
    ...
    'autoTimingCorrection': "تصحيح التوقيت التلقائي",
    'autoTimingCorrectionDesc': "استخدام توقيت اللغة الإنجليزية لتصحيح وترجمة الترجمات تلقائياً (عطّله لاستخدام التوقيت الأصلي)",
